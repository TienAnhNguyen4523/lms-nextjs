    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className="flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 cursor-pointer"
        >
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            ...
            <Link
              ...
              className="text-xs font-semibold text-[#fe5933] hover:underline"
            >
              Forgot password?
            </Link>
          </div>
      ...
      <p className="text-center text-sm text-gray-600">
        ...
        <Link href="/sign-up" className="font-bold text-[#fe5933] hover:underline">
          Sign up
        </Link>
      </p>
    </div>
